...
namespace QFSW.QC.Internal
{
    internal class DummyParameter : ParameterInfo
    {
        ...
        public DummyParameter(Type type, string name, int position)
        {
            ...
            var dummyMethod =
                typeof(DummyParameter).GetMethod(nameof(DummyMethod), BindingFlags.NonPublic | BindingFlags.Static);
        ...
        {
            return _internalDummy.GetCustomAttributes(inherit);
        }

        public override object[] GetCustomAttributes(Type attributeType, bool inherit)
        {
            return _internalDummy.GetCustomAttributes(attributeType, inherit);
        }

        public override IList<CustomAttributeData> GetCustomAttributesData()
        {
            return _internalDummy.GetCustomAttributesData();
        }
        ...
        {
            return _internalDummy.GetOptionalCustomModifiers();
        }

        public override Type[] GetRequiredCustomModifiers()
        {
            return _internalDummy.GetRequiredCustomModifiers();
        }
