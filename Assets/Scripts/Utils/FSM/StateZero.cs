...
{
    public abstract class StateZero
    {
        ...
        protected StateZero(StateMachine machine)
        {
        ...
        protected void GoToState<T, TPayLoad>(Func<bool> when, TPayLoad payLoad) where T : BaseStateWithPayLoad<TPayLoad>
        {
